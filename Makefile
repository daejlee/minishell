...
#    Updated: 2022/12/31 17:08:52 by hkong            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSE_DIR = parse/
SRCS_PARSE = parse.c interpret_env.c interpret_quotes.c split_spaces.c split_operator.c modify_arg.c syntax_error.c
